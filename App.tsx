...
import { fetchVideos, updateLikesInDB } from './supabaseClient';
import AppBar from './components/AppBar';
import MainContent from './components/MainContent';
import ShortsPlayerOverlay from './components/ShortsPlayerOverlay';
import LongPlayerOverlay from './components/LongPlayerOverlay';
import TrendPage from './components/TrendPage';
import SavedPage from './components/SavedPage';
import UnwatchedPage from './components/UnwatchedPage';
import PrivacyPage from './components/PrivacyPage';
import HiddenVideosPage from './components/HiddenVideosPage';
...
const App: React.FC = () => {
  ...
  const filteredVideos = useMemo(() => {
    // نمرر جميع الفيديوهات لـ MainContent وهي تتولى التصفية والاحلال
    return videos;
  }, [videos]);
  ...
  const renderContent = () => {
    const activeVideos = filteredVideos.filter(v => !interactions.dislikedIds.includes(v.id || v.video_url));
